"""
Django settings for testonreview_12 project.
...
ROOT_URLCONF = 'testonreview_12.urls'
...
WSGI_APPLICATION = 'testonreview_12.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testonreview_12 API",
    "DESCRIPTION": "API documentation for testonreview_12 App",
    "VERSION": "v1",
}
